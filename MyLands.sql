...
--
-- Host: localhost:3306
-- Generation Time: Jul 20, 2020 at 02:45 PM
...
CREATE TABLE `admins` (
  ...
  `forgot_password_hash` varchar(32) DEFAULT NULL
...
CREATE TABLE `page_elements` (
  `admin_id` int(10) UNSIGNED DEFAULT NULL,
  `id` int(10) UNSIGNED NOT NULL,
  `type` enum('Logo Image URL','Logo Text','Top Text','Header Menu','Home Page - Intro Text','Home Page - Footer Text','Home Page - Footer') NOT NULL,
...
ALTER TABLE `trans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tran_admin_id` (`admin_id`);
...
--
ALTER TABLE `trans`
  ADD CONSTRAINT `tran_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

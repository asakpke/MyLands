...
السلام علیکم، مائی لینڈز ڈاٹ پی کے کیا ہے؟ یہ پراپرتی ڈیلرز کے لیے بنایا گیا پروگرام ہے۔ اس میں آپ جائیداد کا ریکارڈ رکھ سکتے ہیں۔ یہ ریکارڈ آپ صرف اپنے لیے بھی محفوظ کر سلتے ہیں یا اسے پبلک بنا سکتے ہیں ۔ پبلک ریکارڈز سب لوگ دیکھ سکتے ہیں۔ اپنے آفس کے رجسٹر کھاتوں سے جان چھڑائیں اور آن لائن  کے طرف آئیں۔ 
        </p>
